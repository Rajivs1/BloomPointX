    ...
    <div className="font-sans min-h-screen w-full">
      ...
      <section className="relative bg-gradient-to-r from-blue-800 via-blue-700 to-blue-900 text-white py-20 w-full overflow-hidden">
        ...
        <div className="container mx-auto px-4 max-w-7xl relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6 animate-float bg-gradient-to-r from-white to-blue-200 bg-clip-text text-transparent">Contact Us</h1>
      ...
      <section className="py-16 md:py-24 w-full">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {/* Contact Form */}
            <div className="glass-effect rounded-lg p-8 animate-float" style={{animationDelay: '0.1s'}}>
              <h2 className="text-2xl font-bold mb-3 text-white">Send Us a Message</h2>
              ...
              <form>
                <div className="mb-6">
                  ...
                  <input 
                    type="text" 
                    id="name" 
                    className="w-full px-4 py-2 rounded-lg glass-effect border border-blue-400/30 text-white placeholder-blue-300/70 focus:outline-none focus:border-blue-500 transition-all"
                ...
                <button 
                  type="submit" 
                  className="bg-gradient-to-r from-blue-500 to-blue-700 hover:from-blue-600 hover:to-blue-800 text-white font-semibold py-3 px-8 rounded-lg transition-all duration-300 transform hover:-translate-y-1 btn-shiny animate-pulse-glow"
                >
                  Send Message
                </button>
              </form>
            ...
            <div className="animate-float" style={{animationDelay: '0.3s'}}>
              <h2 className="text-2xl font-bold mb-3 text-white">Contact Information</h2>
              <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-purple-500 mb-8 rounded-full"></div>
              <div className="space-y-8">
                <div className="flex items-start glass-effect p-4 rounded-lg hover:translate-y-[-5px] transition-all duration-300">
                  <div className="bg-gradient-to-r from-blue-500 to-blue-700 p-3 rounded-lg mr-4">
                ...
                <div className="flex items-start glass-effect p-4 rounded-lg hover:translate-y-[-5px] transition-all duration-300">
                  <div className="bg-gradient-to-r from-purple-500 to-purple-700 p-3 rounded-lg mr-4">
                ...
                <div className="flex items-start glass-effect p-4 rounded-lg hover:translate-y-[-5px] transition-all duration-300">
                  <div className="bg-gradient-to-r from-green-500 to-green-700 p-3 rounded-lg mr-4">
                ...
                <div className="flex items-start glass-effect p-4 rounded-lg hover:translate-y-[-5px] transition-all duration-300">
                  <div className="bg-gradient-to-r from-yellow-500 to-yellow-700 p-3 rounded-lg mr-4">
              ...
              <div className="mt-12">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="bg-gradient-to-r from-blue-600 to-blue-800 hover:from-blue-500 hover:to-blue-700 text-white p-3 rounded-full transition-all duration-300 hover:-translate-y-1">
      ...
      <section className="py-16 md:py-24 w-full">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="h-96 rounded-lg overflow-hidden shadow-xl glass-effect p-2 animate-float">
            <iframe 
      ...
      <section className="py-16 md:py-24 w-full">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-3 text-white">Common Questions</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to-purple-500 mx-auto mb-6 rounded-full"></div>
            <p className="text-lg text-gray-300 max-w-2xl mx-auto">
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="glass-effect rounded-lg p-6 border-l-4 border-blue-500 hover:translate-y-[-5px] transition-all duration-300 animate-float" style={{animationDelay: '0.1s'}}>
            ...
            <div className="glass-effect rounded-lg p-6 border-l-4 border-purple-500 hover:translate-y-[-5px] transition-all duration-300 animate-float" style={{animationDelay: '0.3s'}}>
            ...
            <div className="glass-effect rounded-lg p-6 border-l-4 border-green-500 hover:translate-y-[-5px] transition-all duration-300 animate-float" style={{animationDelay: '0.5s'}}>
